...
> **Denna fil är den primära dokumentationskällan** och läses automatiskt av Claude Code
> via `@docs/CLAUDE.md`-referensen i rotfilens `CLAUDE.md`.
> Läs hela filen innan du rör någon kod. Avvikelser från reglerna här
> kräver explicit motivering.
>
> Dokumentationsfilerna för projektet finns samlade i `docs/`:
> - `docs/CLAUDE.md` — den här filen (projektregler, arkitektur, DB-schema)
> - `docs/ARCHITECTURE.md` — kodstandard och separation of concerns
> - `docs/cursorrules.md` — Cursor-specifika regler och byggprinciper
...
## Arkitekturprinciper (läs docs/ARCHITECTURE.md för fullständig spec)
...
```
sokhar/                              ← Repo-rot
├── CLAUDE.md                        ← Tunn pekare → docs/CLAUDE.md (läses av Claude Code)
├── ARCHITECTURE.md                  ← Tunn pekare → docs/ARCHITECTURE.md
├── .cursorrules                     ← Tunn pekare → docs/cursorrules.md (läses av Cursor)
├── docs/                            ← ALL projektdokumentation samlas här
│   ├── CLAUDE.md                    ← DEN HÄR FILEN — primär projektspec
│   ├── ARCHITECTURE.md              ← Kodstandard och separation of concerns
│   ├── cursorrules.md               ← Cursor-specifika regler och byggprinciper
│   ├── 00-START_HERE.md
...
Spårar vilka syskon ett företag är registrerat på, för fakturering och support i Command Center.
Migration: `20260319110000_organization_sites.sql`
...
- `company` ger **inte** automatisk tillgång till alla syskon — kräver aktiv registrering per syskon (spåras i `organization_sites`).
...
- `docs/ARCHITECTURE.md` — kodstandard, separation of concerns, namngivning
- `docs/cursorrules.md` — Cursor-specifika regler och byggprinciper
